...
$(function() {
    ...
    $('.share_sns_btn').on('click', function(){
    ...
    .progress(function(instance, image) {
        if (image.isLoaded) {
            ...
            //console.log('사진', loadedCount, '/', photoCount, 'w', img_w, 'h', img_h, 'rw', img_resized_w, 'rh', img_resized_h)
    ...
    .always(function() {
        ...
        console.log('모든 사진이 로드되었습니다.', nw, 'x', nh)
    })
